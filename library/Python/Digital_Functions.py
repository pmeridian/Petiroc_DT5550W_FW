...
def REG_tot16_GET(handle):
    [err, data] = __abstracted_reg_read(Digital_RegisterFile.SCI_REG_tot16, handle)
    return err, data

def REG_tot16_SET(data, handle):
    err = __abstracted_reg_write(data, Digital_RegisterFile.SCI_REG_tot16, handle)
    return err
