...
HD_PWD='C:/Users/pccmsdaq02/Petiroc/Digital/output/Digital/Digital.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log top_Digital.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source top_Digital.tcl -notrace
