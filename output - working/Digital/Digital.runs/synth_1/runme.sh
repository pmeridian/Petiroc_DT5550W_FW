...
HD_PWD='C:/Users/pccmsdaq02/Petiroc/Digital/output/Digital/Digital.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log top_Digital.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source top_Digital.tcl
